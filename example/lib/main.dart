...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget _buildList() => [
    ...
    {"name": "Fish", "color": Colors.red},
    {"name": "Pork", "color": Colors.orange},
    {"name": "World", "color": Colors.blue},
    {"name": "Book", "color": Colors.indigo},
    {"name": "Fish", "color": Colors.red},
    {"name": "Pork", "color": Colors.orange},
    {"name": "World", "color": Colors.grey},
    {"name": "Book", "color": Colors.purpleAccent},
    {"name": "Fish", "color": Colors.purple},
    {"name": "Pork", "color": Colors.amber},
    {"name": "World", "color": Colors.brown},
    {"name": "Book", "color": Colors.cyan},
  ].grid(
          (item) => LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
